(function(factory) {
    ...
    _.extend(Backbone.View.prototype, {
        ...
        stickit: function(optionalModel, optionalBindingsConfig, options) {
            var model = optionalModel || this.model,
                keepOld = (options && options.keepOld) || false,
            ...
            this.addBinding(model, bindings, null, keepOld);
        ...
        addBinding: function(optionalModel, second, binding, keepOld) {
            var $el, options, modelAttr, config, selector,
                model = optionalModel || this.model,
                namespace = '.stickit.' + model.cid,
                binding = binding || {},
                keepOld = keepOld || false,
                bindId = _.uniqueId();
    ...
    var initializeAttributes = function(view, $el, config, model, modelAttr) {
        var props = ['autofocus', 'autoplay', 'async', 'checked', 'controls', 'defer', 'disabled', 'hidden', 'indeterminate', 'loop', 'multiple',
        ...
        update: function($el, val, model, options) {
            ...
            var addSelectOptions = function(optList, $el, fieldVal) {
                _.each(optList, function(obj) {
                    ...
                    if (!isMultiple && optionVal != null && fieldVal != null && optionVal === fieldVal || (_.isObject(fieldVal) && _.isEqual(
                            optionVal, fieldVal)) ||
                        (fieldVal.toString() === optionVal.toString()) && parseInt(optionVal, 10) === parseInt(fieldVal, 10)) {
